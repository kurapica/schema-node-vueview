<template>
  <section v-if="keyNode" style="width: 100%; min-width: 120px;">
    ...
    <schema-view v-else style="width: 100%;" :key="localeNode.guid" :node="keyNode" :plainText="plainText"
    ...
    <!-- show trans -->
    <el-drawer v-model="showTrans" :title="_L['system.localetran.tran'] + ` ${keyNode.rawData || ''}`" direction="rtl"
...
const displayData = ref(localeNode.rawData)
